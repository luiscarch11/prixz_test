...
abstract class ResultOr<F> {
  ...
  static FutureOr<ResultOr<F>> fromRequest<F>(
    FutureOr<ResultOr<F>> Function() request, {
    FutureOr<ResultOr<F>> Function(DioError error)? onDioError,
    Map<String, F>? failureMapper,
    F? defaultError,
  }) async {
    assert((failureMapper == null && defaultError == null) ||
        (failureMapper != null && defaultError != null));
    assert((failureMapper == null && onDioError != null) ||
        (failureMapper != null && onDioError == null));
    try {
      ...
      if (failureMapper != null) {
        if (e.response?.data is Map && e.response?.data['error'] != null)
          return ResultOr.failure(
              failureMapper[e.response?.data['error']] ?? defaultError!);
        return ResultOr.failure(defaultError!);
      }
